                ...
                <div class="card-body p-4">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="attendance" role="tabpanel">
                            <h5>Current Month Attendance History: (<?php echo e($year); ?>-<?php echo e($month); ?>)</h5>
                            <div class="table-responsive">
                                <table class="table table-borderless align-middle mb-0">
                                    <thead class="table-light">
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $attendanceRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$at): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="fw-medium"><?php echo e($key + 1); ?></td>
                                                <td><?php echo e($at->user ? $at->user->name : ''); ?></td>
                                                <td><?php echo e($at->date); ?></td>
                                                <td><?php echo e($at->punch_in); ?></td>
                                                <td><?php echo e($at->punch_out); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <tr>
                                                <td>No record Found.</td>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="time" name="duty_time_start" class="form-control" id="duty_time_start"
                                                value="<?php echo e($user->duty_time_start); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="time" name="duty_time_end" class="form-control" id="duty_time_end"
                                                value="<?php echo e($user->duty_time_end); ?>">
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bokhtiartoshar/Desktop/Project/Sajon Bhai/visaExpert.com-master/resources/views/backend/user/profile/edit.blade.php ENDPATH**/ ?>