...
<!-- list.js min js -->
<script src="<?php echo e(asset('backend/assets/libs/list.js/list.min.js')); ?>"></script>

<!--list pagination js-->
<script src="<?php echo e(asset('backend/assets/libs/list.pagination.js/list.pagination.min.js')); ?>"></script>

<!--Swiper slider js-->
<script src="<?php echo e(asset('backend/assets/libs/swiper/swiper-bundle.min.js')); ?>"></script>

<!-- Dashboard init -->
<script src="<?php echo e(asset('backend/assets/js/pages/dashboard-ecommerce.init.js')); ?>"></script>
...
<?php /**PATH /Users/bokhtiartoshar/Desktop/Project/Sajon Bhai/visaExpert.com-master/resources/views/layouts/backend/partials/includes/scripts.blade.php ENDPATH**/ ?>