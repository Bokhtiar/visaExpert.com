                                            ...
                                            <tbody>
                                                ...
                                                <?php $__empty_1 = true; $__currentLoopData = $visaTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$visaType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="my-2">
                                                            <?php if($visaType->is_admin == 1): ?>
                                                                <a class="" 
                                                                    href="<?php echo e(route('admin.visa-types.admin.status', $visaType->id)); ?>">
                                                        ...
                                                        <td class="my-2">
                                                            <?php if($visaType->is_user == 1): ?>
                                                                <a class="" 
                                                                    href="<?php echo e(route('admin.visa-types.user.status', $visaType->id)); ?>">
                                                                    <img src="<?php echo e(asset('backend/assets/images/active.png')); ?>"
                                                                        height="30px" alt="">
                                                                </a>
                                                            <?php else: ?>
                                                        ...
                                                        <td>
                                                            <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'Visa Update Type')): ?>
                                                                <div class="hstack gap-3 fs-15">
                                                                    ...
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                                <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'Visa Delete Type')): ?>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bokhtiartoshar/Desktop/Project/Sajon Bhai/visxpert/visaExpert.com-master/resources/views/backend/visa-type/index.blade.php ENDPATH**/ ?>