                                ...
                                <div class="tab-pane active" id="serviceInformation" role="tabpanel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="type_remarks1" id="type_remarks1"
                                                           class="form-control" value="<?php echo e($customer->forms[0]->type_remarks1); ?>">
                                                </div>
                                            </div>
                                            
                                            <div class="row mb-3">
                                                <div class="col-lg-3">
                                                    <label for="application_id" class="form-label">Temporary Application ID :</label>
                                                </div>
                                                <div class="col-lg-9">
                                                    <input type="text" name="application_id" id="application_id"
                                                           class="form-control" value="<?php echo e($customer->forms[0]->application_id); ?>" maxlength="15" placeholder="max 15 chr.">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-lg-3">
                                                    <label for="web_file_app_id" class="form-label">Web File / Application ID :</label>
                                                </div>
                                                <div class="col-lg-9">
                                                    <input type="file" name="web_file_app_id" id="web_file_app_id"
                                                           class="form-control" value="<?php echo e($customer->forms[0]->web_file_app_id); ?>" accept=".pdf" maxlength="2097152">
                                                           
                                                <span>Already added: <a href="<?php echo e(asset('public/'.$customer->forms[0]->web_file_app_id)); ?>" target="_blank"><?php echo e($customer->name); ?> PDF</a></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="type_remarks2" id="type_remarks2"
                                                           class="form-control" value="<?php echo e($customer->forms[0]->type_remarks2); ?>">
                                                </div>
                                            </div>
                                             ...
                                             <div class="row mb-3">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="file" name="image" id="image"
                                                           class="form-control" value="<?php echo e($customer->forms[0]->image); ?>" accept="image/*">
                                                    <span>Already added: <img height="50" width="50" src="<?php echo e(asset('public/'.$customer->forms[0]->image)); ?>" alt="Not upload"></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-9">
                                                   <a href="<?php echo e(asset('public/'.$customer->forms[0]->web_file_app_id)); ?>" target="_blank"><?php echo e($customer->name); ?> PDF</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-9">
                                                    <img height="50" width="50" src="<?php echo e(asset('public/'.$customer->forms[0]->image)); ?>" alt="Not upload">
                                ...
                                <div class="tab-pane" id="personalInformation" role="tabpanel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="customerItems">
                                            ...
                                            <!--    </div>-->
                                            <!--    <div class="col-lg-9">-->
                                            <!--        <?php echo e($customer->type_remarks1); ?>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            ...
                                            <!--    </div>-->
                                            <!--    <div class="col-lg-9">-->
                                            <!--        <?php echo e($customer->application_id); ?>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            ...
                                            <!--    </div>-->
                                            <!--    <div class="col-lg-9">-->
                                            <!--       <a href="<?php echo e(asset($customer->web_file_app_id)); ?>" download><?php echo e($customer->name); ?> PDF</a>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            ...
                                            <!--    </div>-->
                                            <!--    <div class="col-lg-9">-->
                                            <!--        <?php echo e($customer->type_remarks2); ?>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            <!--<div class="row mb-3">-->
                                            <!--    <div class="col-lg-3">-->
                                            ...
                                            <!--    </div>-->
                                            <!--    <div class="col-lg-9">-->
                                            <!--        <img height="50" width="50" src="<?php echo e(asset('public/'.$customer->image)); ?>" alt="Not upload">-->
                                        ...
                                        <form id="updateCustomerForm"
                                              action="<?php echo e(route('admin.customers.update', $customer->id)); ?>"
                                            ...
                                            <!--    <div class="col-lg-9">-->
                                            <!--        <input type="text" name="type_remarks1" id="type_remarks1"-->
                                            <!--               class="form-control" value="<?php echo e($customer->type_remarks1); ?>">-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            ...
                                            <!--    <div class="col-lg-9">-->
                                            <!--        <input type="text" name="application_id" id="application_id"-->
                                            <!--               class="form-control" value="<?php echo e($customer->application_id); ?>" maxlength="15" placeholder="max 15 chr.">-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            ...
                                            <!--    <div class="col-lg-9">-->
                                            <!--        <input type="file" name="web_file_app_id" id="web_file_app_id"-->
                                            <!--               class="form-control" value="<?php echo e($customer->web_file_app_id); ?>" accept=".pdf" maxlength="2097152">-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            ...
                                            <!--    <div class="col-lg-9">-->
                                            <!--        <input type="text" name="type_remarks2" id="type_remarks2"-->
                                            <!--               class="form-control" value="<?php echo e($customer->type_remarks2); ?>">-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            ...
                                            <!--    <div class="col-lg-9">-->
                                            <!--        <input type="file" name="image" id="image"-->
                                            <!--               class="form-control" value="<?php echo e($customer->image); ?>" accept="image/*">-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                                ...
                                                <?php $__empty_1 = true; $__currentLoopData = $customer->forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <?php $__empty_2 = true; $__currentLoopData = $form->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                        <tr>
                                                            ...
                                                            <?php endif; ?>
                                                            <td id="document-status-<?php echo e($document->id); ?>"><?php echo e($document->status ?? 'Waiting for Review'); ?></td>
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(\App\Permissions::EDIT_CUSTOMER)): ?>
                                                                <td>
                                                                    <div class="d-flex gap-2 align-items-center">
                                                                        <div class="form-check form-radio-success">
                                                                            <input
                                                                                class="form-check-input document-status"
                                                                                type="radio"
                                                                ...
                                                                <div class="table-responsive table-card">
                                                                    <table class="table align-middle table-nowrap"
                                                                        ...
                                                                        <?php $__empty_1 = true; $__currentLoopData = $customer->invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                            <tr>
                                                                                <td class="fw-medium text-center"><?php echo e($key + 1); ?></td>
                                                                                <td><?php echo e($invoice->customer->unique_id); ?></td>
                                                                                <td><?php echo e(ucfirst($invoice->customer->name)); ?></td>
        ...
        $(document).ready(function () {
            $(document).on('change', '.document-status', function () {
                ...
                $.ajax({
                    ...
                    url: '/admin/customers/' + customerId + '/forms/' + formId + '/documents/' + documentId + '/update-status',
                    data: {
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/visatuey/public_html/resources/views/backend/customer/show.blade.php ENDPATH**/ ?>