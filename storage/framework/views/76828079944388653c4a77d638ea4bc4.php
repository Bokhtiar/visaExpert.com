...
<a href="<?php echo e(route('admin.customers.offline')); ?>" class="btn btn-success">
   Create New Customer (Offline mood)
    ...
    <img height="40" width="40" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTs0OQohCvwwikklzYqaMr7EGNYjw5bawOZcKbEGk1n-A&s" alt="">
</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                       <?php 
            $invoice = App\Models\Invoice::where('customer_id', $customer->id)->first();
        ...
        <?php if($invoice): ?>
            ...
            <?php elseif($invoice->status == "Due"): ?>
                <a  class="btn btn-danger btn-sm" href="<?php echo e(route('admin.customers-invoices.create', $customer->id)); ?>">
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/visatuey/public_html/resources/views/backend/customer/index.blade.php ENDPATH**/ ?>