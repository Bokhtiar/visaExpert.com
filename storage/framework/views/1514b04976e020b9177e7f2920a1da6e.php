                                            ...
                                            <tbody>
                                                ...
                                                <?php $__empty_1 = true; $__currentLoopData = $holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'Holiday Edit')): ?>
                                                                <a href="<?php echo e(route('admin.holiday.edit', $holiday->id)); ?>"
                                                                    class="btn btn-warning">Edit</a>
                                                            <?php endif; ?>
                                                            <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'Holiday Delete')): ?>
                                                                <form
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bokhtiartoshar/Desktop/Project/Sajon Bhai/visaExpert.com-master/resources/views/backend/holiday/index.blade.php ENDPATH**/ ?>