...
@section('title',  isset($edit) ? 'Edit Road' : 'Create New Roa d')
                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <div>
                                    <a href="{{ route('admin.road.index') }}" class="btn btn-clr-red">
                        ...
                        <div class="card-body">
                            <form id="visa-form"
                                  action="{{ isset($edit) ? route('admin.road.update', $edit->id) : route('admin.road.store') }}"
                                  method="POST">
                                @csrf
                                @if (isset($edit))
                                    @method('PUT')
