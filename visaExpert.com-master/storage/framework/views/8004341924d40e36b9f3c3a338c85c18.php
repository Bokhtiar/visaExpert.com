                                                ...
                                                <tbody>
                                                    <tr class="border-top border-top-dashed">
                                                        ...
                                                        <td>
                                                            <input type="number" name=""
                                                                <?php
$payAmountWithDiscount = $invoice->total_amount - $invoice->discount; ?>
                                                                value="<?php echo e($payAmountWithDiscount - $total_pay); ?>"
                                                                class="form-control bg-light border-0" placeholder="0"
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bokhtiartoshar/Desktop/Project/Sajon Bhai/visxpert/visaExpert.com-master/resources/views/backend/customer/invoice/edit.blade.php ENDPATH**/ ?>