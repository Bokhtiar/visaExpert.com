            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(\App\Permissions::VIEW_CUSTOMER)): ?>
                    <li class="nav-item my-1">
                        <a
                            class="nav-link menu-link <?php echo e(request()->routeIs('admin.customers.*') ? 'active' : ''); ?>"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(\App\Permissions::VIEW_VISA_TYPE)): ?>
                    <li class="nav-item my-1">
                        <a
                            class="nav-link menu-link <?php echo e(request()->routeIs('admin.visa-types.*') ? 'active' : ''); ?>"
                            href="#sidebarVisaTypes"
                            data-bs-toggle="collapse"
                            role="button"
                            aria-expanded="false"
                        ...
                        <div class="collapse menu-dropdown <?php echo e(request()->routeIs('admin.visa-types.*') ? 'show' : ''); ?>"
                            ...
                            <ul class="nav nav-sm flex-column">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(\App\Permissions::CREATE_VISA_TYPE)): ?>
                                    <li class="nav-item">
                                        <a
                                            href="<?php echo e(route('admin.visa-types.create')); ?>"
                                ...
                                <li class="nav-item">
                                    <a
                                        href="<?php echo e(route('admin.visa-types.index')); ?>"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(\App\Permissions::VIEW_SERVICE, \App\Permissions::VIEW_TOUR_PACKAGE)): ?>
                    <li class="nav-item my-1">
                        ...
                        <div
                            class="collapse menu-dropdown <?php echo e(request()->routeIs('admin.services.*', 'admin.tour-packages.*') ? 'show' : ''); ?>"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(\App\Permissions::VIEW_ROLE, \App\Permissions::VIEW_USER)): ?>
                    <li class="nav-item my-1">
                        <a
                            class="nav-link menu-link <?php echo e(request()->routeIs('admin.roles.*', 'admin.users.*') ? 'active' : ''); ?>"
                        ...
                        <div
                            class="collapse menu-dropdown <?php echo e(request()->routeIs('admin.roles.*', 'admin.users.*') ? 'show' : ''); ?>"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(\App\Permissions::VIEW_DAILY_OFFICE_EXPENSE, \App\Permissions::VIEW_STAFF_DUTY_SALARY)): ?>
                    <li class="nav-item my-1">
                        <a class="nav-link menu-link <?php echo e(request()->routeIs('admin.daily-office-expenses.*', 'admin.staff-duty-salaries.*') ? 'active' : ''); ?>"
                           href="#sidebarBilling"
                           data-bs-toggle="collapse"
                           role="button"
                           aria-expanded="false"
                        ...
                        <div
                            class="collapse menu-dropdown <?php echo e(request()->routeIs('admin.daily-office-expenses.*', 'admin.staff-duty-salaries.*') ? 'show' : ''); ?>"
                            id="sidebarBilling">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a
                                        href="<?php echo e(route('admin.daily-office-expenses.index')); ?>"
...
<?php /**PATH /home/visatuey/visa.visaxpert.net/resources/views/layouts/backend/partials/leftSidebar.blade.php ENDPATH**/ ?>