                                ...
                                <table class="table table-borderless align-middle table-nowrap mb-0">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="text-center">#<?php echo e($form->submit_for_other ? $form->customer_id : $form->user->customer_id); ?></td>
                                            <td>
                                                <?php echo e($form->submit_for_other ? $form->applicant_name : $form->user->name); ?>

                                            </td>
                                            <td><?php echo e(Str::ucfirst($form->service->visaType->title)); ?></td>
                                            <td>
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/visatuey/visa.visaxpert.net/resources/views/frontend/customer/my-forms/index.blade.php ENDPATH**/ ?>