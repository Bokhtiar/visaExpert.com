...
<?php $__env->startSection('content'); ?>
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'Create Package')): ?>
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'Update Package')): ?>
...
unset($__errorArgs, $__bag); ?>"
                                                    name="name" id="packageName" placeholder="Enter a package name"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-floating">
                                                <input type="text" class="form-control <?php $__errorArgs = ['place_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    id="nameOfPlace" name="place_name" placeholder="Enter the name of place"
...
unset($__errorArgs, $__bag); ?>"
                                                    min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" name="journey_date"
                                        ...
                                        <td>
                                            <div class="hstack gap-3 fs-15">
                                                <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'Update Package')): ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'Delete Package')): ?>
