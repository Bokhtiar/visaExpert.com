    ...
    <nav class="navbar navbar-expand-lg navbar-landing fixed-top bg-light shadow-lg" id="navbar">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('backend/assets/images/logo.jpg') }}" alt="logo" height="80">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <form action="{{ route('search-form') }}" class="d-flex align-items-center mx-auto search-box"
                      role="search">
                    <input class="form-control me-2 @error('user_id') is-invalid @enderror" type="search" name="user_id"
                ...
                <ul class="navbar-nav mt-2 mt-lg-0 d-flex justify-content-between gap-2" id="navbar-example">
                    <li class="nav-item">
                        <a class="nav-link fs-5 {{ request()->routeIs('home') ? 'active' : '' }}"
                           href="{{ route('home') }}">
